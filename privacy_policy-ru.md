...
Пользователь сам определяет на каких доменах (сайтах) будет работать
расширение "JS Blocker Extension".
...
Главное приложение, расширения "JS Blocker Extension", файл "script.js":
