    ...
    static func dump() {
            ...
            if (!items.isEmpty) {
                ...
                let rows: [String] = items.reduce(into: []) { result, item in
                    ...
                    result.append(
                        ">> domain      : \(formattedDomain     .toWidth(80))\n" +
                        ">> frame domain: \(formattedFrameDomain.toWidth(80))\n" +
                        ">> url         : \(formattedURL        .toWidth(80))\n" +
                        ">> created at  : \(formattedCreatedAt  .toWidth(80))"
                    )
                }
                ...
                >> =================================================================================================
                >> domain + frame domain + url + created at                 
                >> =================================================================================================
                """)
                ...
                for (index, line) in rows.enumerated() {
                    ...
                    if (index != rows.count - 1) {
                        Logger.customLog(">> " + String(repeating: "- ", count: 49) + "\n")
                    }
                }
