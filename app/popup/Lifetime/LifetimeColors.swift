...
extension Color {
    ...
    enum LifetimeColorSet {
        ...
        static let popupListItemBackground       = Color("color Lifetime Popup List Item Background")
        static let popupListItemActiveBackground = Color("color Lifetime Popup List Item Active Background")
    }
